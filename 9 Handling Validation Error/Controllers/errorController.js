...
const validationErrorHandler = (err) => {
    //This err is the error object
    //Inside the rror object we have errors property which has the validation error which has a value property
    //Map all these values to errors array and join it with ". "
    //This way we can handle multiple validation errors
...
module.exports=(error,req,res,next)=>{
    ...
    if(process.env.NODE_ENV === 'development'){
        ...
        //If there is a validation error say we inout a name less than 3 charcters
        //We can handle one or more validation errors at once
