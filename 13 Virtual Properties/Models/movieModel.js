...
const movieSchema = new mongoose.Schema({
    ...
    toJSON: {virtuals: true},       //send virtual properties in JSON whenever JSON is outputted
    toObject: {virtuals: true}      //display virtual properties in object whenever objects are displayed
}
);

//This is a virtual property
//We are using an anonympus function as callback instead of arrow because we are using this keyword
//Arrow functions dont get this keyword
//In this anonymous function this points to the object from which this function is being called
//These virtual properties are not part of the document so we cant use them in queries
