...
//Here we can access environment variables evn though we didint import config file
//This is because once env variables are set they will set for the entire application
//env variables should be read only once
