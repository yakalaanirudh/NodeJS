...
//app.use(morgan())
//but we use app.use(logger)
//Because logger itself is a middleware function but morgan and express.json()
//returns a middleware function so we invoke them
//app.use(morgan("dev"))
// returns Request Type URL response code 200 or 404 time to receive response size of response
//app.use(morgan("tiny"))
// returns Request Type URL response code 200 or 404  size of response time to receive response
...
//STEP 1
const moviesRouter= express.Router()    //express.Router returns a middleware which we store it in  moviesRouter
//Similarly if we have another resource say TVSeries we will create a router named tvSeriesRouter
...
//STEP 2
//Since moviesRouter is middleware we can use use() to apply it to requests
app.use('api/v1/movies',moviesRouter)

//Now we can remove the url from movies Router
