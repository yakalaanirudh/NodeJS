...
userschema.pre(/^find/,function(next){
    //inside this points to the current query and adds a condition active must be true in filters
    this.find({active:true})

    //this.find({active:{$ne:false}})   //find all where active is not equals false
    next()
})
